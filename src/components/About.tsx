...
const About = () => {
  ...
  return (
    <section
      id="about"
      className="py-12 sm:py-20 bg-subtle-gradient"
      style={{
        display: teams.length == 0 && "none",
      }}
    >
        ...
        <div className="mb-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              A wonderful team of younglings who put all there effort and heart
              in doing God's work and delivering seamless worshipping to ECUF.
            </p>
          </div>
            ...
            {teams.map((team, index) => (
              ...
              >
                <CardContent className="pt-6">
                  ...
                  <p className="text-muted-foreground text-sm">{team.phone}</p>
                </CardContent>
              </Card>
            ))}
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="w-[100%]">
              ...
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                To create a Christ-centered learning environment where students
                develop academically, spiritually, and socially, preparing them
                to be faithful servants and leaders in their communities and
                beyond.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                We believe that education and faith go hand in hand, forming the
                complete person God intends each of us to be.
              </p>
            </div>
            <div className="border shadow rounded-xl p-8 text-center">
              ...
              <p className="text-muted-foreground mb-6">
                Experience the warmth of Christian fellowship and the excellence
